...
export function LocalTTSModule() {
  ...
  const gerarAudio = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast({
          title: "✅ Áudio gerado!",
          description: `Voz ${voz} processada com sucesso via servidor local`,
        });
      } else {
  ...
  return (
    <div className="p-6 space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between">
        <div>
          <h2 className="text-2xl font-bold text-foreground">🎤 Piper TTS Local</h2>
          <p className="text-muted-foreground">Geração de áudio via servidor Piper TTS local</p>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4">
            ...
            <div>
              <Label htmlFor="voz">Voz Local</Label>
      ...
      {audioHistory.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle>Histórico de Áudios Locais</CardTitle>
          </CardHeader>
          <CardContent>
